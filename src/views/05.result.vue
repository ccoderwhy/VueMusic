    ...
    <el-tabs v-model="activeIndex">
      <el-tab-pane label="歌曲" name="songs">
        <table class="el-table">
          ...
          <tbody>
            <tr v-for="(item,index) in songList" :key="index" class="el-table__row" @click="playMusic(item.id)">
              <td>1</td>
              <td>
                <div class="song-wrap">
                  <div class="name-wrap">
...
<!--                  二级标题-->
      ...
      <el-tab-pane label="歌单" name="lists">
        <div class="items">
          <div v-for="(item,index) in playlists"
               :key="index"
               class="item"
    ...
    activeIndex(){
      ...
      axios({
        ...
        if(type == 1){
          ...
          //计算歌曲时间
          for(let i = 0; i <this.songList[i].duration.length;i++){
              //获取总毫秒数
